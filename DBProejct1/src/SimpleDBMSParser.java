...
// grammar file Í∑∏Î?Î°? Íµ¨ÌòÑ
  ...
  static final public PrintMessages deleteQuery() throws ParseException {
                                String tn; BooleanValueExpression bve = null; String count;
    ...
    {if (true) return new PrintMessages(Flags.DELETE_DONE, count);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public BooleanValueExpression whereClause() throws ParseException {
  ...
  static final public Table referedTable() throws ParseException {
                         Table t; String tn; String newTn = null;
    tn = tableName();
    if (jj_2_1(4)) {
      jj_consume_token(AS);
      newTn = tableName();
  ...
  static final public BooleanValueExpression booleanValueExpression() throws ParseException {
                                                    BooleanTerm bt; BooleanValueExpression bve;
  ...
  static final public BooleanTerm booleanTerm() throws ParseException {
                              BooleanFactor bf; BooleanTerm bt;
    bt = new BooleanTerm();
    bf = booleanFactor();
  ...
  static final public BooleanFactor booleanFactor() throws ParseException {
                                  BooleanTest bt; boolean isNot = true;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT:
    ...
    bt = booleanTest();
    {if (true) return new BooleanFactor(bt, isNot);}
    throw new Error("Missing return statement in function");
  }

  static final public BooleanTest booleanTest() throws ParseException {
                              Predicate p; BooleanValueExpression bve;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LEGAL_IDENTIFIER:
    case INT_VALUE:
    case DATE_VALUE:
    ...
    {if (true) return new BooleanTest(bve);}
      break;
    default:
      jj_la1[11] = jj_gen;
      jj_consume_token(-1);
  ...
  static final public Predicate predicate() throws ParseException {
                          ComparisonPredicate cp; NullPredicate np;
    if (jj_2_2(4)) {
      // choice conflict Î∞úÏÉù, LOOKAHEAD ?Ç¨?ö©
  ...
  static final public ComparisonPredicate comparisonPredicate() throws ParseException {
                                              Item left; Item right; String compOp;
    left = compOperand();
    jj_consume_token(COMP_OP);
    compOp = token.image;
    right = compOperand();
    {if (true) return new ComparisonPredicate(left, right, compOp);}
    throw new Error("Missing return statement in function");
  }

  static final public Item compOperand() throws ParseException {
                       Value v; String tn = null; String cn;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT_VALUE:
    case DATE_VALUE:
    case CHAR_STRING:
      v = comparableValue();
    {if (true) return new Item(v);}
      break;
    case LEGAL_IDENTIFIER:
      if (jj_2_3(4)) {
        // choice conflict Î∞úÏÉù, LOOKAHEAD ?Ç¨?ö©
  ...
  static final public BooleanValueExpression parenthesizedBooleanExpression() throws ParseException {
                                                            BooleanValueExpression bve;
    jj_consume_token(LEFT_PAREN);
    bve = booleanValueExpression();
    jj_consume_token(RIGHT_PAREN);
  ...
  static final public NullPredicate nullPredicate() throws ParseException {
                                  String tn = null; String cn; boolean isNull;
    if (jj_2_4(4)) {
      // choice conflict Î∞úÏÉù, LOOKAHEAD ?Ç¨?ö©
          tn = tableName();
      jj_consume_token(PERIOD);
    ...
    {if (true) return new NullPredicate(new Item(tn, cn), isNull);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public void tableExpression() throws ParseException {
                           ArrayList<Table> tl; BooleanValueExpression bve = null;
    tl = fromClause();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case WHERE:
      bve = whereClause();
