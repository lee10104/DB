...
// grammar file ê·¸ë?ë¡? êµ¬í˜„
  ...
  static final public PrintMessages dropTableQuery() throws ParseException {
    ...
    {if (true) return new PrintMessages(Flags.DROP_TABLE_DONE);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public Column columnDefinition() throws ParseException {
                              String cn; DataType dt; boolean isNull = false; boolean isPrivateKey = false;
    cn = columnName();
    dt = dataType();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT_NULL:
    ...
    {if (true) return new Column(cn, dt, isNull, isPrivateKey);}
    throw new Error("Missing return statement in function");
  }
